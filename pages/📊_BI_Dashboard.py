...
with st.expander('Activity Insights Dashboard'):
    st.header("Activity Insights Dashboard")
    ...
    if filtered_df.empty:
        ...
        with col1:
            ...
            st.scatter_chart(filtered_df, x='DISTANCE_KM', y='TOTAL_ELEVATION_GAIN_M')
...
if prompt := st.chat_input("E.g., What was my longest run in August?"):
